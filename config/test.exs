...
config :takso, TaksoWeb.Endpoint,
  ...
  secret_key_base: "Mt7ZIvpHveYJoWIpEPl9YDI4JcWCqG7ai+nq0w+06IzKjp6Oj0tASNalWtWsP3rg",
  server: true
...
config :hound, driver: "chrome_driver", port: 54114  # If needed, update the port according to the chrome_drive message
